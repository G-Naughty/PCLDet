...
class ConRoITransRoIHead(BaseModule, metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        super(ConRoITransRoIHead, self).__init__(init_cfg)
    ...
    def _bbox_forward(self, stage, x, rois):
        ...
        if stage < self.num_stages - 1:
            ...
            cls_score, bbox_pred, contrast_feature = bbox_head(bbox_feats)
            bbox_results = dict(
                cls_score=cls_score, bbox_pred=bbox_pred,
                contrast_feature=contrast_feature, bbox_feats=bbox_feats)
        return bbox_results
