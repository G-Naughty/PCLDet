...
class RubbishDataset(CustomDataset):
    ...
    """
    CLASSES = ('canhe', 'glass', 'lilebao', 'suliaop', 'yilaguan', 'package', 'qita')
    ...
    def __init__(self,
        ...
        super(RubbishDataset, self).__init__(ann_file, pipeline, **kwargs)
    ...
    def format_results(self, results, submission_dir=None, nproc=4, **kwargs):
        ...
        result_files = self._results2submission(id_list, dets_list,
                                                submission_dir)
        mmcv.dump(dets_list, submission_dir+'dets.pkl')
