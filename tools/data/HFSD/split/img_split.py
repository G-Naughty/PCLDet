...
def add_parser(parser):
    ...
    parser.add_argument(
        '--base_json',
        type=str,
        default='/home/ggm/GGM/mmrotate/tools/data/HFSD/split/split_configs/hfsd/ss_test.json',
...
def load_dota(img_dir, ann_dir=None, nproc=10):
    ...
    print('Starting loading OFSD dataset information.')
...
def _load_dota_txt(txtfile):
    ...
    """
    rubbish_category=['JS Muroto', 'Tachikaze-class destroyer', 'Shirane-class destroyer',
                      'Asahi-class destroyer', 'JS Asuka', 'JS Chiyoda',
                     'Awaji-class minesweeper', 'Ford Aircraft Carrier', 'Watson class vehicle cargo ship']
        ...
        with open(txtfile, 'r') as f:
            for line in f:
                ...
                if len(items) >= 9:
                    ...
                    if items[8] in rubbish_category:
                        items[8]= 'unknown'
                    new_label_name = items[8].strip().split(' ')
                    items[8]= '_'.join(new_label_name)
