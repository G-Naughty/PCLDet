custom_imports = dict(
    imports=["mmdet.datasets.logdet_mini"]
)
# data_prefix = '/data112/bianhao/competitions/data/logdet-mini'
...
datasetA = dict(
    type=dataset_type,
    ann_file='data/fewshotlogodetection/train/split_json/instances_train2017.json',
...
data = dict(
    ...
    val=dict(
        type=dataset_type,
        ann_file='data/fewshotlogodetection/train/split_json/instances_val2017.json',
        img_prefix='data/fewshotlogodetection/train/images',
...
lr_config = dict(
    ...
    warmup_iters=250,
    warmup_ratio=0.001,
    step=[8, 11])  #最大epoch为12时step=[8,11];36时应对应[8*3,11*3]
...
_base_=[
    '/data112/bianhao/competitions/mmdetection/mycode/stage1_config/swinb_3x_800-1400_anchor_bs2x8.py'
]
